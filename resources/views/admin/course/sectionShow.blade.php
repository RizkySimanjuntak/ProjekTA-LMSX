                                ...
                                <div class="card-body">
                                    ...
                                    @if($subTopic->labels->count() > 0)
                                        <div class="card-body">
                                            ...
                                            <ul class="list-group">
                                                @forelse($subTopic->quizs as $quiz)
                                                    <li class="list-group-item">

                                                        <a href="{{ route('questions.create', $quiz->id) }}"><i class="bi bi-tag fs-3"></i> {!! $quiz->name !!}</a>
                                                ...
                                                <div class="tab-content" id="myTabContent{{ $subTopic->id }}">
                                                    ...
                                                    <div class="tab-pane fade" id="knowledge{{ $subTopic->id }}" role="tabpanel" aria-labelledby="knowledge-tab{{ $subTopic->id }}">
                                                        <div class="row">
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">
                                                                    <a href={{ route('folders.create', ['sub_topic_id' => $subTopic->id]) }}><i class="bi bi-folder fs-3"></i><br>Folder </a>
                                                                </button>
                                                            </div>
                                                            <div class="col-4 text-center mb-3">
                                                                <button class="btn btn-outline-primary w-100">

...
//});
Route::get('/', function () {
    return view('welcome'); // or any response
});
...
//    Route::resource('users', UsersController::class);
    ...
    Route::get('/topik/{section_id}', [TopikController::class, 'showtopikmahasiwa'])->name('topik.showtopikmahasiwa');
...
//    });
    ...
    Route::get('/folders/create', [MDLFolderController::class, 'create'])->name('folders.create');
...
Route::get('/quizsmahasiswa/{id}', [MDLQuizController::class, 'showMahasiswa'])->name('quizsmahasiswa.show');
